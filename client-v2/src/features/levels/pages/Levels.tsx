...
import { getLevelsBySpecialty } from "../api/levels";
...
export default function Levels() {
  ...
  useEffect(() => {
    async function loadLevels() {
      ...
      try {
        ...
        const sortedLevels = [...data].sort(
          (a, b) =>
            (levelOrder[a.name] ?? 999) -
            (levelOrder[b.name] ?? 999)
        );
        ...
        setError(
          err instanceof Error
            ? err.message
            : "تعذر تحميل المستويات الأكاديمية"
        );
      } finally {
        setLoading(false);
      }
  ...
  async function loadSemesters(levelId: string) {
    try {
      ...
      /*
       * ترتيب السداسيات حسب semester_number
       */
      const sortedSemesters = [...data].sort(
        (a, b) => {
          const aNumber = a.semester_number ?? 999;
          const bNumber = b.semester_number ?? 999;
        ...
        >
          ...
          >
            ...
            <div className="p-6 sm:p-8">
              ...
              {!loadingSemesters && semesterError && (
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    {semesters.map((semester) => (
                      ...
                      >
                        ...
                        <p className="mt-2 text-sm leading-6 text-gray-500">
                          استكشف الوحدات والمواد الدراسية لهذا السداسي.
                        </p>
